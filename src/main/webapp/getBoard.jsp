	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<input name="bno" type="hidden" value=<%= board.getBno() %> />
				<table class="table table-bordered">
					<tr>
						<th class="col-xs-3">제목</th>
						<th align="left" class="col-xs-9"><%= board.getTitle() %></th>
					</tr>
					<tr>
						<td>작성자</td>
					...
					<% if(session.getAttribute("userName").equals(board.getWriter())) {%>
					<tr>
						<td colspan="2" align="center">
							<a href="getUpdateBoard.do?bno=<%= board.getBno() %>" class="btn btn-default">글수정</a>&nbsp;&nbsp;&nbsp;
							<a href="deleteBoard.do?bno=<%= board.getBno() %>" class="btn btn-default">글삭제</a>
						</td>
					</tr>
					<% } %>
				</table>
