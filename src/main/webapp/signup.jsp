	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
                ...
                <form action="signup.do" method="post" role="form" class="contactForm">
                    ...
                    <div class="form-group">
                    	<label for="tel" class="control-label col-xs-2">연락처</label>
                        <div class="col-xs-10">
                        	<input type="text" class="form-control" name="tel" placeholder="전화번호를 입력해주세요" />
                        </div>
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                    	<label for="age" class="control-label col-xs-2">나이</label>
                        <div class="col-xs-10">
                        	<input type="text" class="form-control" name="age" placeholder="나이를 입력해주세요" />
                        </div>
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                    	<label for="sex" class="control-label col-xs-2">성별</label>
                        <div class="col-xs-10">
                    ...
                    <center><button type="submit" class="btn btn-theme">가입하기</button></center>
                </form>
			</div>
		</div>
	</div>
