			...
			<div class="col-md-12">
				...
				<form action="insertPet.do" method="post" enctype="multipart/form-data">
					<table class="table table-bordered">
						...
						<tr>
							<td>작성자</td><input name="id" type="hidden" value="<%= session.getAttribute("userId")%>" />
							<td align="left"><input name="writer" type="hidden" value="<%= session.getAttribute("userName")%>" /><%= session.getAttribute("userName")%></td>
						</tr>
						<tr>
							<td>서식지</td>
							<td align="left"><input class="form-control" type="text" name="habitat" /></td>
						</tr>
						<tr>
							<td>내용</td>
						...
						<tr>
							<td colspan="2" align="center"><input class="btn btn-default" type="submit" value="펫 등록" /></td>
						</tr>
					</table>
				</form>
				<hr>
				<a href="getPetList.do" class="btn btn-default">펫 목록가기</a>
			</div>
		</div>
	</div>
	</section>
