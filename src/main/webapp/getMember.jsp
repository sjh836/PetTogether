	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<input name="mno" type="hidden" value=<%= member.getMno() %> />
				<table class="table table-bordered">
					<tr>
						<th class="col-xs-3">아이디</th>
						<th align="left" class="col-xs-9"><%= member.getId() %></th>
					</tr>
					<tr>
						<td>이름</td>
						<td align="left"><%= member.getName() %></td>
					</tr>
					<tr>
						<td>연락처</td>
					...
					<tr>
						<td>나이</td>
						<td align="left"><%= member.getAge() %></td>
					</tr>
					<tr>
						<td>가입일</td>
						<td align="left"><%= member.getRegDate() %></td>
					</tr>
					<tr>
						<td>활동점수</td>
						<td align="left"><%= member.getGrade() %></td>
					</tr>
					<tr>
						<td colspan="2" align="center">
							<a href="deleteMember.do?mno=<%= member.getMno() %>" class="btn btn-default">회원 제명</a>
						</td>
					</tr>
				</table>
			</div>
